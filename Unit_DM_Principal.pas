...
type
  Tdm_principal = class(TDataModule)
    ...
    ado_proc_consulta_alunosSEXO_ALUNO: TStringField;
    ado_proc_consulta_alunosALTURA_ALUNO: TBCDField;
    ado_proc_consulta_alunosPESO_ALUNO: TBCDField;
    ado_proc_consulta_alunosOBJETIVO_ALUNO: TStringField;
    ado_proc_consulta_alunosFOTO_ALUNO: TBlobField;
    ...
    ado_query_consulta_alunoNIVEL_ATIVIDADE_ALUNO: TStringField;
    ...
    ado_query_consulta_completa_alunoNIVEL_ATIVIDADE_ALUNO: TStringField;
