...
(
	...
	FICHA_TREINO_DIA VARCHAR(10) NOT NULL, 
...
(
	...
	SERIES_EXERCICIO_TREINO INT NULL,
	REPETICOES_EXERCICIO_TREINO VARCHAR(10) NULL,
	TEMPO_EXERCICIO_TREINO VARCHAR(12) NULL,
	CARGA_EXERCICIO_TREINO VARCHAR(10) NULL,
	OBS_EXERCICIO_TREINO TEXT NULL,
...
(
	ID_AGENDAMENTO INT IDENTITY PRIMARY KEY NOT NULL,
	ID_ALUNO INT FOREIGN KEY REFERENCES TB_DADOS_PESSOAIS_ALUNO(ID_ALUNO) NOT NULL,
	DATA_HORA_CONSULTA_AGENDAMENTO DATETIME NOT NULL,
	DATA_HORA_REALIZA_AGENDAMENTO DATETIME NOT NULL,
...
(
	...
	AGENDAMENTO_CONSULTA INT FOREIGN KEY REFERENCES TB_AGENDAMENTOS(ID_AGENDAMENTO) NOT NULL,
	ALUNO_CONSULTA INT FOREIGN KEY REFERENCES TB_DADOS_PESSOAIS_ALUNO(ID_ALUNO) NOT NULL,
